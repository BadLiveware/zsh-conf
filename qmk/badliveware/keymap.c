...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_TAB,         KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,           KC_QUOTE,                                       KC_NONUS_BSLASH,KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           US_ARNG, 
    KC_ESCAPE,      KC_A,           KC_S,           KC_D,           KC_F,           KC_G,           US_COMM,                                        KC_SLASH,       KC_H,           KC_J,           KC_K,           KC_L,           US_ODIA,        US_ADIA,
    KC_LSHIFT,      KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                                                           KC_N,           KC_M,           US_COMM,        US_DOT,         US_SCLN,        KC_RSHIFT,      
    KC_LCTRL,       KC_LGUI,        KC_LALT,        KC_LEFT,        KC_RIGHT,                KC_APPLICATION,                                        LSFT(KC_APPLICATION),           KC_UP,          KC_DOWN,        KC_LBRACKET,    KC_RBRACKET,    MO(1),          
                                                                    KC_SPACE,       KC_DELETE,      KC_LGUI,                                        KC_LALT,        KC_BSPACE,      KC_ENTER
  ),
  [1] = LAYOUT_moonlander(
